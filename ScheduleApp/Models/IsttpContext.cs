...
public partial class IsttpContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Assignment>(entity =>
        {
            ...
            entity.Property(e => e.Deadline).HasColumnType("timestamp without time zone").HasColumnName("deadline");
            entity.Property(e => e.Description).HasColumnName("description");
            entity.Property(e => e.SubjectId).HasColumnName("subject_id");
            entity.Property(e => e.Status).HasColumnName("status"); 
            entity.HasOne(d => d.Subject).WithMany(p => p.Assignments).HasForeignKey(d => d.SubjectId).HasConstraintName("assignments_subject_id_fkey");
        });
        ...
        modelBuilder.Entity<Note>(entity =>
        {
            ...
            entity.Property(e => e.SubjectId).HasColumnName("subject_id");
            entity.HasOne(d => d.Subject).WithMany(p => p.Notes).HasForeignKey(d => d.SubjectId).HasConstraintName("notes_subject_id_fkey");
        });
        ...
        modelBuilder.Entity<Schedule>(entity =>
        {
            ...
            entity.HasOne(d => d.Subject).WithMany(p => p.Schedules).HasForeignKey(d => d.SubjectId).HasConstraintName("schedule_subject_id_fkey");
            entity.HasOne(d => d.Teacher).WithMany(p => p.Schedules).HasForeignKey(d => d.TeacherId).HasConstraintName("schedule_teacher_id_fkey");
        });
        ...
        modelBuilder.Entity<ScheduleEvent>(entity =>
        {
            ...
            entity.HasOne(d => d.Entry).WithMany(p => p.ScheduleEvents).HasForeignKey(d => d.EntryId).HasConstraintName("schedule_events_entry_id_fkey");
        });
        ...
        modelBuilder.Entity<Subject>(entity =>
        {
            ...
            entity.HasOne(d => d.User).WithMany(p => p.Subjects).HasForeignKey(d => d.UserId).HasConstraintName("subjects_user_id_fkey");
        });
        ...
        modelBuilder.Entity<Teacher>(entity =>
        {
            ...
            entity.Property(e => e.UserId).HasColumnName("user_id");
            entity.HasOne(d => d.User).WithMany(p => p.Teachers).HasForeignKey(d => d.UserId).HasConstraintName("teachers_user_id_fkey");
        });
